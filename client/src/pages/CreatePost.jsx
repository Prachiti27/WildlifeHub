  ...
  return (
    <div className='min-h-screen bg-gradient-to-b from-slate-50 to-white'>
      <div className='max-w-6xl mx-auto p-6'>
        <div className='mb-8'>
          <h1 className='text-3xl font-bold text-[#074240] mb-2'>Create Post</h1>
        ...
        <div className='max-w-xl bg-white p-4 sm:p-8 rounded-xl shadow-md space-y-4'>
          ...
          <div className='flex items-center justify-between pt-3 border-t border-gray-300'>
            ...
            <button
              ...
              className='text-sm bg-gradient-to-r from-[#074240] to-[#12A8A3] active:scale-95 transition text-white font-medium px-8 py-2 rounded-md cursor-pointer'
            >
              Publish Post
            </button>
          </div>
