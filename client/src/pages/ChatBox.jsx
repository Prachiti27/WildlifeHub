...
const ChatBox = () => {
  ...
  return user && (
    <div className='flex flex-col h-screen'>
      <div className='flex items-center gap-2 p-2 md:px-10 xl:pl-42 bg-gradient-to-r from-[#074240]/30 to-[#12A8A3]/10 border-b border-gray-300'>
                ...
                <div className={`p-2 text-sm max-w-sm bg-white text-slate-700 rounded-lg shadow ${message.to_user_id !== user._id ? 'rounded-bl-none' : 'rounded-br-none'}`}>
                  {
                    ...
                    className='w-full max-w-sm rounded-ld mb-1'
                  />
                  }
                  <p>{message.text}</p>
                </div>
      ...
      <div className='px-4'> 
          <div className='flex items-center gap-3 pl-5 p-1.5 bg-white w-full max-w-xl mx-auto border border-gray-200 shadow rounded-full mb-5'>
            ...
            <button onClick={sendMessage} className='bg-gradient-to-br from-[#074240] to-[#12A8A3] active:scale-95 cursor-pointer text-white p-2 rounded-full'>
