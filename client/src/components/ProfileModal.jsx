    ...
    <div className='fixed top-0 bottom-0 left-0 right-0 z-110 h-screen overflow-y-scroll bg-black/50'>
      <div className='max-w-2xl sm:py-6 mx-auto'>
        <div className='bg-white rounded-lg shadow p-6'>
            <h1 className='text-2xl font-bold text-[#074240] mb-6'>Edit Profile</h1>
            ...
            <form className='space-y-4' onSubmit={ e => toast.promise(
                ...
                <div className='flex flex-col items-start gap-3'>
                    <label htmlFor='profile_picture' className='block text-sm font-medium text-gray-700 mb-1'>
                        ...
                        <div className='group/profile relative'>
                            ...
                            />
                            <div className='absolute inset-0 hidden group-hover/profile:flex top-0 right-0 bottom-0 bg-black/20 rounded-full items-center justify-center'>
                ...
                <div className='flex flex-col items-start gap-3'>
                    <label htmlFor='cover_photo' className='block font-medium text-gray-700 mb-1'>
                        Cover Photo
                        <input
                            type='file'
                            accept='image/*'
                ...
                <div className='flex justify-end space-x-3 pt-6'>
                    ...
                    <button 
                        type='submit'
                        className='px-4 py-2 bg-gradient-to-r from-[#074240] to-[#12A8A3] text-white rounded-lg transition cursor-pointer'
                    >
                        Save changes
                    </button>
                </div>
