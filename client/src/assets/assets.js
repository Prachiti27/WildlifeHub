...
export const menuItemsData = [
    { to: '/community', label: 'Feed', Icon: Home },
    { to: '/community/messages', label: 'Messages', Icon: MessageCircle },
    { to: '/community/connections', label: 'Connections', Icon: Users },
    { to: '/community/discover', label: 'Discover', Icon: Search },
    { to: '/community/profile', label: 'Profile', Icon: UserIcon },
];
